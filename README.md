...
## Tutorial Install BePresensi Mobile

1. Clone project ini
2. Buka folder project ini dengan Android Studio
3. Jika terdapat class yang tidak di load, klik tab `Build` lalu klik `Rebuild Project`
