package com.jtk.bepresensi.api

import com.jtk.bepresensi.util.Constants
import com.jtk.bepresensi.util.DateTypeDeserializer
...
//    fun GetSpecificPatientCompletedAppointment(@Path("Id") Id : String) : Observable<List<GetSpecificPatientCompletedAppointmentResponse>>
    ...
    fun getComic(@Path("number") nomorUrut :Int) : Observable<Comics>
